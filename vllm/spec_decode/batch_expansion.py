...
class BatchExpansionTop1Scorer(SpeculativeScorer):
    ...
    def _split_scoring_output_hpu(
        ...
        # done by supporting per-sequence proposal lens.
        #
        # First group of samples are from non-speculative scoring, second group
        # of samples are speculative samples. Remaining samples are dummy
        # samples from padding the batch.
